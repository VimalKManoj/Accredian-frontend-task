    ...
    <header className="w-full py-5 sm:px-10 px-5 flex justify-between items-center border-b border-n-6/50 lg:backdrop-blur-sm ">
      <nav className="flex w-full screen-max-width justify-between lg:bg-n-1/80 ">
        <div className="flex  items-center ">
          ...
          <div className="flex md:hidden pl-28 "><MenuIcon/></div>
          <button className="hidden lg:flex justify-center items-center px-6 py-1 bg-blue text-white rounded-md h-10 sm:hidden">
            Courses
          </button>
        </div>
        <div className="hidden lg:flex  items-center w-[360px] justify-between transition-colors">
        ...
        <div className="w-[240px] flex items-center justify-between">
          <button className="hidden md:flex  px-6 py-1 bg-grey/20 rounded-md h-10">
            Login
          </button>
          <button className="hidden md:flex  px-6 py-1 bg-blue text-white rounded-md h-10">
            Try for free
          </button>
        </div>
      </nav>
